...
from db.models import Scene, GraphicsWall, GraphicsGround, BattleMap
...
def seed_scene_data(db: Session):
    scene1 = Scene(name='Forest', description='A lonely Forest', graphics_ground_id='1', graphics_wall_id='1')
    scene2 = Scene(name='Forest', description='A lonely Forest', graphics_ground_id='2', graphics_wall_id='2')
    scene3 = Scene(name='Forest', description='A lonely Forest', graphics_wall_id='3', battlemaps_id='1')
    db.add(scene1)
    db.add(scene2)
    db.add(scene3)
    db.commit()
